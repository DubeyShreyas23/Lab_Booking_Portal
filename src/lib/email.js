...
function fromHeader() {
  const name = process.env.MAIL_FROM_NAME || 'Central Analytical Laboratory';
...
const SIG = () =>
  ...
  `For more information, please contact ${process.env.LAB_CONTACT || 'Dr Ramakrishnan Ganesan'}`;
...
module.exports = {
  ...
  async otpMail(to, code) {
    return sendMail({
      to,
      subject: 'Your CAL portal login code',
      text:
        `Greetings from Central Analytical Laboratory!\n\n` +
